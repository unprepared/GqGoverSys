				...
				<div class="form-bottom">
						...
						<div class="col-xs-6">
							<div class="form-group">
								<label for="form-firstName">姓氏</label> <input type="text"
									...
									class="form-firstName form-control" id="form-firstName"/>
							</div>
						</div>
						<div class="col-xs-6">
							<div class="form-group">
						...
						<div class="col-xs-6">
							<div class="form-group">
								<label for="form-spellName">拼音名</label> <input type="text"
									...
									class="form-spellName form-control" id="form-spellName" />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<label for="form-hkDetails">详细户口所在地</label> <input type="text"
							...
							class="form-hkDetails form-control" id="form-hkDetails"/>
					</div>
				...
				<div class="form-bottom">
					<div class="form-group">
						<label for="form-idCardNo">身份证号码</label> <input type="text"
							...
							class="form-idCardNo form-control" id="form-idCardNo"/>
					</div>
					<div class="form-group">
						...
						<div class="col-xs-6">
							<div class="form-group">
								<label for="form-recipient">收件人</label> <input type="text"
									...
									class="form-recipient form-control" id="form-recipient"/>
							</div>
						</div>
						<div class="col-xs-6">
							<div class="form-group">
								<label for="form-postcode">邮编</label> <input type="text"
									...
									class="form-postcode form-control" id="form-postcode" />
							</div>
						</div>
					</div>
					<div class="form-group">
						<label for="form-rTelphone">收件人联系号码</label> <input type="text"
							...
							class="form-rTelphone form-control" id="form-rTelphone"/>
					</div>
					<div class="form-group">
						<label for="form-rAddress">收件详细地址</label> <input type="text"
							name="rAddress" placeholder="请填写收件人详细地址"
							class="form-rAddress form-control" id="form-rAddress"/>
					</div>
					<div class="form-group">
						<strong>领取地址：</strong>
